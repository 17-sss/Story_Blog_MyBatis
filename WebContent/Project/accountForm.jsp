...
<head>
	...
	<style type="text/css">
		...
		.bgimg {
		    background-image: url("/Story_Blog_MyBatis/Project/img/back1.jpg");
		    min-height: 100%;
...
<input type="button" value="Back" class="w3-button w3-red" OnClick="window.location='/Story_Blog_MyBatis/story/index'">  
